...
if TELEGRAM_BOT_TOKEN:
    ...
    logging.warning(
        "TELEGRAM_BOT_TOKEN environment variable not set. Bot will not be able to send messages."
    )
...
if __name__ == "__main__":
    if not bot or not gemini_model:
        print(
            "ERROR: TELEGRAM_BOT_TOKEN and GEMINI_API_KEY must be set as environment variables to run."
        )
    else:
